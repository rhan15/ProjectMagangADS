    ...
    init: function () {
        ...
        !(function () {
            ...
            function o(e, t, a) {
                var o = "",
                    s = "";
                t - e < 100 || "Today" == a ? ((o = "Today:"), (s = e.format("MMM D"))) : "Yesterday" == a ? ((o = "Yesterday:"), (s = e.format("MMM D"))) : (s = e.format("MMM D") + " - " + t.format("MMM D")),
            ...
            (function () {
                ...
                if (e) {
                    var a = KTUtil.getCssVariableValue("--bs-gray-800"),
                        o = KTUtil.getCssVariableValue("--bs-gray-800"),
                        s = KTApp.isDarkMode() ? KTUtil.getCssVariableValue("--bs-gray-200") : "#D6D6E0";
                    new ApexCharts(e, {
                        series: [{ name: "Net Profit", data: [30, 25, 45, 30, 55, 55] }],
                        chart: { fontFamily: "inherit", type: "area", height: t, toolbar: { show: !1 }, zoom: { enabled: !1 }, sparkline: { enabled: !0 } },
                        plotOptions: {},
